/*
    ...
    WAITS FOR PAGE TO LOAD, SELECTS SIZE, AND PROCEEDS TO CHECKOUT

    edit var size in one() to the appropriate value for the 
    item you would like to purchase

    ex: Large, Medium, S/M, Multi
    */
...
waitForKeyElements("#img-main", one);
